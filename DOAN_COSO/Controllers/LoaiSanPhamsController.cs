...
namespace DOAN_COSO.Controllers
{
    public class LoaiSanPhamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDLoaiSP,tenLoaiSP,Hinh")] LoaiSanPham loaiSanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDLoaiSP,tenLoaiSP,Hinh")] LoaiSanPham loaiSanPham)
        {
            if (ModelState.IsValid)
            {
